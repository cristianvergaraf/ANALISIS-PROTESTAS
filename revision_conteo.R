### Este es un pequeño fichero para contar el numero de protestas que existieron en todas las comunas para verificar que el resultado de la funcion macro_protestas es correcto
