...
## incluye el código de la comuna central.
##
...
##### Ahora aplicamos la función para todas las comunas y obtemos un shape para cada comuna, que es exportado a un geopackage creado en el directorio indicado.
